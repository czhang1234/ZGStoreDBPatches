...
Set @Desc = 'Rename and Drop Tables';
...
drop table Users
EXEC sp_rename ''Customer'', ''User'';
drop table [dbo].[GiftRegistryProduct]
drop table dbo.GiftRegistry 
drop table [dbo].[ProductReviewCaregoryProductReview]
